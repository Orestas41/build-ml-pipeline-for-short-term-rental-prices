...
def go(args):
    ...
    # Getting the Random Forest configuration and updating W&B
    ...
    # Removing the column "price" from X and putting it into y
    y = X.pop("price")
    ...
    # Exporting the inference pipeline
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # Imputing the missing review date with an old date and creating a new
    # feature from it
